...
모든 추가 데이터(KAMIS 도매시장 가격, MAFRA 소비 트렌드, 농촌진흥청 출하 가이드 PDF, 공공데이터 등)는 **농가 진단(PortfolioDiagnosis — 기존 경영진단 FarmDiagnosis가 여기로 통합됨)을 중심으로 연관성을 가져야 한다**. 독립된 탭으로 따로 노는 것은 안 됨.
